-- Layer_5 Step51 MCP smoke：BS Profile（小样本验证 SQL 是否可跑）
...
DROP TABLE IF EXISTS public."Y_codex_Layer5_Smoke_BS_Profile";

CREATE TABLE public."Y_codex_Layer5_Smoke_BS_Profile" AS
WITH
params AS (
  SELECT
...
ANALYZE public."Y_codex_Layer5_Smoke_BS_Profile";
