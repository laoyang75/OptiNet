...
DROP TABLE IF EXISTS rb5._profile_seed_grid;
DROP TABLE IF EXISTS rb5._profile_primary_seed;
DROP TABLE IF EXISTS rb5._profile_seed_distance;
DROP TABLE IF EXISTS rb5._profile_core_cutoff;
DROP TABLE IF EXISTS rb5._profile_core_points;
DROP TABLE IF EXISTS rb5._profile_core_gps;
DROP TABLE IF EXISTS rb5._profile_counts;
...
DROP TABLE IF EXISTS rb5.cell_core_seed_grid;
DROP TABLE IF EXISTS rb5.cell_core_primary_seed;
DROP TABLE IF EXISTS rb5.cell_core_seed_distance;
DROP TABLE IF EXISTS rb5.cell_core_cutoff;
DROP TABLE IF EXISTS rb5.cell_core_points;
DROP TABLE IF EXISTS rb5.cell_core_gps_stats;
