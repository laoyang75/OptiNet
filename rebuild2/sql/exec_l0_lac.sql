...
-- STEP 6: 重建 l0_lac — cell_infos 部分
...
-- STEP 6：重建 l0_lac — ss1 部分（信号按制式匹配）
...
-- STEP 6：合并 + ODS 清洗 → 最终 l0_lac
DROP TABLE IF EXISTS rebuild2.l0_lac_new;
CREATE TABLE rebuild2.l0_lac_new AS
WITH merged AS (
